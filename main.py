...
# Custom Keras layer to wrap TensorFlow Hub layer
...
hub_layer = HubWrapper(model_url)
...
with user_input:
    ...
    choice = int(st.number_input('Exercise: 1. Bicep Curl 2. Shoulder Press 3. High Knees', max_value=3, step=1))

with model_container:
    # Your remaining code for capturing video and performing pose estimation goes here
    pass
